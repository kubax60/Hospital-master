...
<tr style= "background-color:black;" allign="center">
...
<td> <a class="bt btn-danger" onclick="return confirm('are you sure to delete this?') href="{{url('cancel_appoint')}}">Cancel</a></td>
